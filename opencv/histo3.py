...
for i in range(10,30):
    ...
    image=cv2.imread("/home/jose/Desktop/opencv/dst"+str(i)+"/histo_frame.jpg")
    image2=cv2.imread("/home/jose/Desktop/opencv/dst"+str(i)+"/window.jpg")
    plt.subplot(2,2,1)
    ...
    plt.savefig("/home/jose/Desktop/opencv/dst"+str(i)+'/hist_R'+str(i)+'.png')