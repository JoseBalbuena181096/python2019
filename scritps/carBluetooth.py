...
class App():
    def __init__(self):
        ...
        self.sensor1 = Label(self.myframe,text="Sensor 1 : ",fg="red",font=(30), bg="white")
        self.sensor1.config(bd=10)
        self.sensor1.config(relief="groove")
        self.sensor1.grid(row=0,column=0,sticky="e",padx=50,pady=20)
        
        self.sensor2 = Label(self.myframe,text="Sensor 2 : ",fg="red",font=(30), bg="white")
        self.sensor2.config(bd=10)
        self.sensor2.config(relief="groove")
        self.sensor2.grid(row=1,column=0,sticky="e",padx=50,pady=20)

        self.sensor3 = Label(self.myframe,text="Sensor 3 : ",fg="red",font=(30), bg="white")
        self.sensor3.config(bd=10)
        self.sensor3.config(relief="groove")
        self.sensor3.grid(row=2,column=0,sticky="e",padx=50,pady=20)

        self.labelSensor1 = Entry(self.myframe,textvariable=self.sensorString1, bg="white")
        ...
        self.labelSensor2 = Entry(self.myframe,textvariable=self.sensorString2, bg="white")
        ...
        self.labelSensor3 = Entry(self.myframe,textvariable=self.sensorString3, bg="white")
        ...
        self.disconnetButton.config(bd=10)
        self.disconnetButton.config(relief="groove")
